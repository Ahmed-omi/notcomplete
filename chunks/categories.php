			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
				      ...
				      <div class="card-content">
			          <p>This is a popular category of world's best food. Explore the Foods of this category!</p>
			        </div>
				    </div>
				    <div class="card-reveal">
				      ...
				      <p><?php echo $arr_all[$i+$j-2]['long_desc']; ?></p>
								<a href="" class="waves-effect waves-light btn" style="background: #ee6e73 !important;">Register Now &raquo;</a>
				    </div>
				  </div>
			</div>
