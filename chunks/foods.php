...
<?php for ($i=1; $i <= count($arr_all); ) { ?>
		...
		<div class="row">
			...
			<div class="col s12 m4 <?php echo $arr_all[$i+$j-2]['Regime']." ".$arr_all[$i+$j-2]['Origine']." ".$arr_all[$i+$j-2]['Repas']; ?>">
				<div class="card">
				    ...
				    <div class="card-reveal">
				      ...
				      <p><?php echo $arr_all[$i+$j-2]['description']; ?></p>
							<p><?php echo $arr_all[$i+$j-2]['regime']; ?></p>
							<p><?php echo $arr_all[$i+$j-2]['origine']; ?></p>
							<p><?php echo $arr_all[$i+$j-2]['repas']; ?></p>
				    </div>
				  </div>
			</div>
