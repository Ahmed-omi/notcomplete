		...
		<nav>
		    <div class="nav-wrapper">
		      ...
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/King_Resturant" class="hvr-grow">Home</a></li>
		        <li><a href="/King_Resturant/about-us.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/King_Resturant">Home</a></li>
	        <li><a href="/King_Resturant/about-us.php">About Us</a></li>
